...
void Obrero::setSumaSB(double newSB)
{
    m_sumaTotalSB=newSB;
}

void Obrero::setSumaSN(double newSN)
{
    m_sumaTotalSN=newSN;
}

void Obrero::setSumaDes(double newDes)
{
    m_sumaTotalDes=newDes;
}
...
QString Obrero::toStringSumaSBTotal()
{
    QString str ="";
    str.append(QString::number(m_sumaTotalSB));
    return str;
}

QString Obrero::toStringSumaSNTotal()
{
    QString str ="";
    str.append(QString::number(m_sumaTotalSN));
    return str;
}

QString Obrero::toStringSumaDesTotal()
{
    QString str ="";
    str.append(QString::number(m_sumaTotalDes));
    return str;
}
